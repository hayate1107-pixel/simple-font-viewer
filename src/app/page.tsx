        ...
        <div className="border-t border-gray-200 pt-16">
          ...
          <div className="text-left text-sm text-gray-600 leading-relaxed space-y-4">
            <p className="text-xs text-gray-500">
              Simple Font Viewerは、デザイナー・開発者などすべての方のためのオンラインフォント比較ビューアーツールです。プレビューテキスト入力とサイズ調整により、様々な日本語・英語フォントの表示をリアルタイムで確認できます。特に、「PC内フォントを読み込む」機能により、ご自身のパソコンにインストールされたフォントも一覧で比較可能。日本語・英語フォントを判別し読み込むため、言語切り替え機能も搭載。最適なフォント探しの時間と手間を大幅に削減します。
            </p>
            <p className="text-xs text-gray-500">
