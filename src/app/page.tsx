      ...
      >
        ...
        <div className="border-t border-gray-200 pt-16">
          ...
          <div className="text-left text-sm text-gray-600 leading-relaxed space-y-4">
            <p>
              Simple Font Viewerは、デザイナー・開発者などすべての方のためのオンラインフォント比較ビューアーツールです。プレビューしたいテキストを入力し、フォントサイズを調整するだけで、様々な日本語・英語フォントがどのように表示されるかをリアルタイムで確認できます。さらに、「PCフォントを読み込む」機能を使えば、あなたのパソコンにインストールされているお気に入りのフォントも一覧で比較可能です。最適なフォントを見つけるための時間と手間を、大幅に削減します。
            </p>
            <p>
【プライバシーとセキュリティ】PCフォントを読み込む機能はPC内のフォント名のみを取得し、その他のファイルやデータには一切アクセスしません。読み込んだフォント情報はあなたのブラウザ内でのみ処理され、外部サーバーには送信されません。ログインや個人情報の登録は不要で、利用料金もかかりません。すべての処理はブラウザ内で完結するため、安心して安全にご利用いただけます。
            </p>
