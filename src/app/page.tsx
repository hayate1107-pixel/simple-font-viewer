...
import { Languages, FolderDown, Mail, Shuffle, Coffee, ChevronDown } from 'lucide-react';
...
export default function HomePage() {
  ...
  const [donationUrl, setDonationUrl] = useState('https://buy.stripe.com/fZuaEW6mWeb7g6C4AeaR202'); 
        ...
        <div className="border-t border-gray-200 pt-16">
          ...
          <div className="text-left text-sm text-gray-600 leading-relaxed space-y-4">
            <p className="text-xs text-gray-500">
              Simple Font Viewerは、デザイナー・開発者などすべての方のためのオンラインフォント比較ビューアーツールです。プレビューテキスト入力とサイズ調整により、様々な日本語・英語フォントの表示をリアルタイムで確認できます。「PC内フォントを読み込む」機能により、ご自身のパソコンにインストールされたフォントも一覧で比較可能。日本語・英語フォントを判別し読み込むため、言語切り替え機能も搭載。最適なフォント探しの時間と手間を大幅に削減します。
            </p>
            <p className="text-xs text-gray-500">
              【プライバシーとセキュリティ】本ツールは、フォント名のみを取得し、その他のデータには一切アクセスしません。読み込んだフォント情報はブラウザ内でのみ処理され、外部サーバーには送信されません。ログインや個人情報登録は不要で、オフラインでの利用も可能です。（初回オンラインアクセスは必要）すべての処理がブラウザ内で完結するため、安心して安全にご利用いただけます。
            </p>
            <p className="text-xs text-gray-500">
              【注意事項】フォントの利用可能性はOSやインストール状況に依存し、モバイル端末には非対応です。日本語・英語フォントの判別は100%正確ではありません。本ツールの利用によるトラブル・損害については保証いたしかねます。
            </p>
          </div>
        </div>
